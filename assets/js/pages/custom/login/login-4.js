...
var KTLogin = function() {
	...
	var _handleFormSignin = function() {
		...
		FormValidation
			...
			.on('core.form.invalid', function() {
				Swal.fire({
					text: "Извините, похоже, что обнаружены некоторые ошибки, пожалуйста, попробуйте еще раз.",
					icon: "error",
					buttonsStyling: false,
	...
	var _handleFormForgot = function() {
		...
		FormValidation
		    ...
		    .on('core.form.valid', function() {
				// Show loading state on button
				KTUtil.btnWait(formSubmitButton, _buttonSpinnerClasses, "Пожалуйста, подождите");
